# Vendored GIFT-EVAL dataset loader.
#
# Self-contained copy of `timecopilot.gift_eval.data.Dataset` (timecopilot==0.0.18),
# itself adapted from https://github.com/SalesforceAIResearch/gift-eval.
#
# Vendored here so the repo does not depend on the full `timecopilot` package, which
# (a) pins an old `transformers==4.40.1` that conflicts with the rest of the stack and
# (b) eager-imports its whole agent stack (pydantic_ai/prophet/tsfeatures) at package
# import time. Only this lightweight loader is needed for GIFT-EVAL.
#
# Dependencies: datasets, pyarrow, python-dotenv, gluonts, pandas, toolz.
